...
# URLS
# ==============================================
API_BASE_URL=https://salesauditamtest.miatech.net
WEB_URL=salesauditamtest.miatech.net
NEXT_PUBLIC_API_URL_LOCAL=https://salesauditamtest.miatech.net/api/v1
NEXT_PUBLIC_API_URL_DEV=https://salesauditamtest.miatech.net/api/v1
NEXT_PUBLIC_API_URL_PROD=https://salesauditamtest.miatech.net/api/v1
...
# ==============================================
# MICROSOFT GRAPH — Waiver mail listener
# ==============================================
MS_GRAPH_TENANT_ID=c528b90b-c482-43eb-9909-a36d74c6920d
MS_GRAPH_CLIENT_ID=d40df925-732c-405c-8600-09c51ae9725a
MS_GRAPH_CLIENT_SECRET=pWm8Q~nNWyt0n_h7ONbQxRm5Y5Taa-ptizJnDbZr
MS_GRAPH_PUBLIC_CLIENT=true
MS_GRAPH_MAILBOX=ppimentel@miatech.net
MS_GRAPH_WAIVER_POLL_ENABLED=true
MS_GRAPH_WAIVER_POLL_INTERVAL_SECONDS=300
MS_GRAPH_REDIRECT_URI=http://localhost
MS_GRAPH_TOKEN_FILE=data/ms_graph_tokens.json
MS_GRAPH_WAIVER_OUTPUT_DIR=\\imagenes\am2\FAREAUDIT GROUP\WAIVERS

# Waiver — usuario iSeries para carga A2537 (poller + A2537INGRE)
WAIVER_DB_USER=SAP54T
WAIVER_DB_PASSWORD=ASDFGHJK1
DB_ODBC_ENCODING=latin-1
