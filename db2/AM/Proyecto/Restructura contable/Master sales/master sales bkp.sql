...
CREATE OR REPLACE PROCEDURE PRAXIS.SQP04481 ( IN IN_OPTION CHAR(1),
                                   ...
                                   IN IN_A1740UNIDA VARCHAR(2), -- READ ONLY
                                   --IN IN_A1740CECOS VARCHAR(6), 
                                   IN IN_A1740CECOS VARCHAR(7), -- REESTRUCTURACION CONTABLE
                                   IN IN_A1740UBICA VARCHAR(4),
                                   --IN IN_A1740CTA VARCHAR(4), 
                                   IN IN_A1740CTA VARCHAR(6), -- REESTRUCTURACION CONTABLE 
                                   IN IN_A1740SCTA VARCHAR(5), -- REESTRUCTURACION CONTABLE (5 a 4 )
